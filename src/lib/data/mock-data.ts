...
// Fase 1 + Fase 2.6: Z-Scores recomputed via the corrected hitungZScore
// (HFA L=1 constant; WFH extended to 45-120 cm). Measurements for non-showcase
// children were tuned via scripts/tune_seed_measurements.py to land all three
// Z-Score indicators in their WHO Normal bands, producing a realistic demo
// distribution (~80% Normal, ~10% Stunting, ~10% Wasting).
export const seedPengukuran: PengukuranBalita[] = [
  // Budi Santoso (L, ~14mo) — Normal
  { id: 101, balitaId: 1, tanggalPengukuran: '2026-01-15', usiaBulan: 14, beratBadanKg: 7.9, tinggiBadanCm: 74.6, zScoreBBU: -1.96, zScoreTBU: 0.16, zScoreBBTB: -0.08, statusGizi: 'Normal' },
  { id: 102, balitaId: 1, tanggalPengukuran: '2025-12-12', usiaBulan: 13, beratBadanKg: 7.9, tinggiBadanCm: 73.9, zScoreBBU: -1.81, zScoreTBU: 0.19, zScoreBBTB: 0.23, statusGizi: 'Normal' },
  { id: 103, balitaId: 1, tanggalPengukuran: '2025-11-14', usiaBulan: 12, beratBadanKg: 7.6, tinggiBadanCm: 72.6, zScoreBBU: -1.96, zScoreTBU: 0.01, zScoreBBTB: 0.06, statusGizi: 'Normal' },
  // Aisyah Putri (P, ~8mo) — Normal
  { id: 201, balitaId: 2, tanggalPengukuran: '2026-01-15', usiaBulan: 8, beratBadanKg: 6.3, tinggiBadanCm: 66.7, zScoreBBU: -1.88, zScoreTBU: 0.18, zScoreBBTB: 0.06, statusGizi: 'Normal' },
  { id: 202, balitaId: 2, tanggalPengukuran: '2025-12-10', usiaBulan: 7, beratBadanKg: 6.0, tinggiBadanCm: 65.0, zScoreBBU: -1.96, zScoreTBU: 0.0, zScoreBBTB: 0.18, statusGizi: 'Normal' },
  // Rizky Pratama (L, ~22mo) — Normal
  { id: 301, balitaId: 3, tanggalPengukuran: '2026-01-15', usiaBulan: 22, beratBadanKg: 8.9, tinggiBadanCm: 79.0, zScoreBBU: -1.96, zScoreTBU: 0.0, zScoreBBTB: 0.23, statusGizi: 'Normal' },
  { id: 302, balitaId: 3, tanggalPengukuran: '2025-12-15', usiaBulan: 21, beratBadanKg: 8.8, tinggiBadanCm: 79.0, zScoreBBU: -1.95, zScoreTBU: 0.17, zScoreBBTB: 0.1, statusGizi: 'Normal' },
  // Cinta Laura (P, ~11mo) — Normal
  { id: 401, balitaId: 4, tanggalPengukuran: '2026-01-15', usiaBulan: 11, beratBadanKg: 6.8, tinggiBadanCm: 69.8, zScoreBBU: -1.98, zScoreTBU: 0.17, zScoreBBTB: -0.02, statusGizi: 'Normal' },
  // Dika Anggara (L, ~34mo) — Normal
  { id: 501, balitaId: 5, tanggalPengukuran: '2026-01-15', usiaBulan: 34, beratBadanKg: 10.1, tinggiBadanCm: 84.8, zScoreBBU: -1.98, zScoreTBU: -0.0, zScoreBBTB: 0.23, statusGizi: 'Normal' },
  { id: 502, balitaId: 5, tanggalPengukuran: '2025-12-15', usiaBulan: 33, beratBadanKg: 10.0, tinggiBadanCm: 84.8, zScoreBBU: -1.98, zScoreTBU: 0.14, zScoreBBTB: 0.11, statusGizi: 'Normal' },
  // Nadia (P, ~14mo) — Normal
  { id: 601, balitaId: 6, tanggalPengukuran: '2026-01-15', usiaBulan: 14, beratBadanKg: 7.3, tinggiBadanCm: 71.8, zScoreBBU: -1.93, zScoreTBU: 0.01, zScoreBBTB: 0.21, statusGizi: 'Normal' },
  // Arkan (L, ~18mo) — Normal
  { id: 701, balitaId: 7, tanggalPengukuran: '2026-01-15', usiaBulan: 18, beratBadanKg: 8.4, tinggiBadanCm: 76.8, zScoreBBU: -1.99, zScoreTBU: 0.0, zScoreBBTB: 0.09, statusGizi: 'Normal' },
  // Kayla (P, ~24mo) — Normal
  { id: 801, balitaId: 8, tanggalPengukuran: '2026-01-15', usiaBulan: 24, beratBadanKg: 8.5, tinggiBadanCm: 77.5, zScoreBBU: -1.86, zScoreTBU: -0.01, zScoreBBTB: 0.35, statusGizi: 'Normal' },
  // Bagas Pratomo (L, ~16mo) — STUNTING case (TB ≈ -2.25 SD below median)
  { id: 901, balitaId: 9, tanggalPengukuran: '2026-01-15', usiaBulan: 16, beratBadanKg: 7.5, tinggiBadanCm: 69, zScoreBBU: -2.62, zScoreTBU: -2.25, zScoreBBTB: 1.13, statusGizi: 'Stunting' },
  { id: 902, balitaId: 9, tanggalPengukuran: '2025-12-15', usiaBulan: 15, beratBadanKg: 7.3, tinggiBadanCm: 68, zScoreBBU: -2.7, zScoreTBU: -2.39, zScoreBBTB: 1.16, statusGizi: 'Stunting' },
  { id: 903, balitaId: 9, tanggalPengukuran: '2025-11-15', usiaBulan: 14, beratBadanKg: 7.1, tinggiBadanCm: 67, zScoreBBU: -2.78, zScoreTBU: -2.51, zScoreBBTB: 1.17, statusGizi: 'Stunting' },
  // Zahra Khairunnisa (P, ~13mo) — WASTING case (BB ≈ -2.66 SD below median)
  { id: 1001, balitaId: 10, tanggalPengukuran: '2026-01-15', usiaBulan: 13, beratBadanKg: 6.5, tinggiBadanCm: 72, zScoreBBU: -2.66, zScoreTBU: 0.35, zScoreBBTB: -1.27, statusGizi: 'Wasting' },
  { id: 1002, balitaId: 10, tanggalPengukuran: '2025-12-15', usiaBulan: 12, beratBadanKg: 6.3, tinggiBadanCm: 71, zScoreBBU: -2.74, zScoreTBU: 0.29, zScoreBBTB: -1.34, statusGizi: 'Wasting' },
];
