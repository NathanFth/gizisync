      ...
      <Tabs defaultValue="profil" className="space-y-5">
        ...
        <TabsContent value="profil">
          <Card className="p-5 sm:p-6">
            ...
            <form
              onSubmit={profilForm.handleSubmit(onProfilSubmit)}
              className="space-y-4"
            >
              <div className="space-y-1.5">
                <Label htmlFor="p-nama">Nama Lengkap</Label>
                <Input id="p-nama" {...profilForm.register("namaLengkap")} />
                {profilForm.formState.errors.namaLengkap && (
                  <p className="text-xs text-destructive">
                    {profilForm.formState.errors.namaLengkap.message}
                  </p>
                )}
              </div>
              <div className="space-y-1.5">
                ...
                <Input
                  id="p-username"
                  value={pengaturan.profil.username}
                  disabled
              ...
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                <div className="space-y-1.5">
                  ...
                  {profilForm.formState.errors.nomorTelepon && (
                    <p className="text-xs text-destructive">
                      {profilForm.formState.errors.nomorTelepon.message}
                    </p>
                  )}
                </div>
                <div className="space-y-1.5">
        ...
        <TabsContent value="posyandu">
          <Card className="p-5 sm:p-6">
            ...
            <form
              onSubmit={posyanduForm.handleSubmit(onPosyanduSubmit)}
              className="space-y-4"
            >
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                <div className="space-y-1.5">
                  ...
                  <Input
                    id="ps-nama"
                    {...posyanduForm.register("namaPosyandu")}
                  />
                  {posyanduForm.formState.errors.namaPosyandu && (
                    <p className="text-xs text-destructive">
                      {posyanduForm.formState.errors.namaPosyandu.message}
                    </p>
                  )}
                </div>
                <div className="space-y-1.5">
                  ...
                  <Input
                    id="ps-ketua"
                    {...posyanduForm.register("namaKetua")}
                  />
                  {posyanduForm.formState.errors.namaKetua && (
                    <p className="text-xs text-destructive">
                      {posyanduForm.formState.errors.namaKetua.message}
                    </p>
                  )}
                </div>
              </div>
              <div className="space-y-1.5">
                ...
                <Input
                  id="ps-alamat"
                  {...posyanduForm.register("alamatLengkap")}
                />
                {posyanduForm.formState.errors.alamatLengkap && (
                  <p className="text-xs text-destructive">
                    {posyanduForm.formState.errors.alamatLengkap.message}
                  </p>
                )}
              </div>
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                <div className="space-y-1.5">
                  ...
                  {posyanduForm.formState.errors.kelurahan && (
                    <p className="text-xs text-destructive">
                      {posyanduForm.formState.errors.kelurahan.message}
                    </p>
                  )}
                </div>
                <div className="space-y-1.5">
                  ...
                  {posyanduForm.formState.errors.kecamatan && (
                    <p className="text-xs text-destructive">
                      {posyanduForm.formState.errors.kecamatan.message}
                    </p>
                  )}
                </div>
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  <Input
                    ...
                    {...passwordForm.register("kataSandiLama")}
                    className="pr-10"
                  />
                  <button
                    type="button"
                ...
                {passwordForm.formState.errors.kataSandiLama && (
                  <p className="text-xs text-destructive">
                    {passwordForm.formState.errors.kataSandiLama.message}
                  </p>
                )}
              </div>
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  <Input
                    ...
                    {...passwordForm.register("kataSandiBaru")}
                    className="pr-10"
                  />
                  <button
                    type="button"
                ...
                {passwordForm.formState.errors.kataSandiBaru && (
                  <p className="text-xs text-destructive">
                    {passwordForm.formState.errors.kataSandiBaru.message}
                  </p>
                )}
              </div>
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  <Input
                    ...
                    {...passwordForm.register("konfirmasiSandi")}
                    className="pr-10"
                  />
                  <button
                    type="button"
                ...
                {passwordForm.formState.errors.konfirmasiSandi && (
                  <p className="text-xs text-destructive">
                    {passwordForm.formState.errors.konfirmasiSandi.message}
                  </p>
                )}
              </div>
              <Button
...
function DataBackupTab() {
  ...
  const handleReset = () => {
    if (
      confirm("PERINGATAN: Semua data akan direset ke data awal. Lanjutkan?")
    ) {
  ...
  return (
    <div className="space-y-5">
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="mt-0.5 text-sm text-muted-foreground">
              Unduh seluruh data Posyandu dalam format JSON untuk cadangan atau
              migrasi.
            </p>
            <Button
      ...
      <Card className="p-5">
        <div className="flex items-start gap-3">
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="mt-0.5 text-sm text-muted-foreground">
              Unggah file backup JSON untuk memulihkan data. Data saat ini akan
              ditimpa.
            </p>
            <input
              ref={fileInputRef}
      ...
      <Card className="border-red-200 bg-red-50/50 p-5 dark:border-red-500/20 dark:bg-red-500/5">
        <div className="flex items-start gap-3">
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="mt-0.5 text-sm text-muted-foreground">
              Hapus semua data dan kembali ke data contoh awal. Tindakan ini
      ...
      <div className="flex items-start gap-2 rounded-lg bg-muted/50 p-3 text-xs text-muted-foreground">
        ...
        <p>
          Data disimpan secara lokal di browser Anda (localStorage). Lakukan
          backup berkala untuk mencegah kehilangan data. Backup JSON berisi data
          Balita dan riwayat Pengukuran.
        </p>
      </div>
      ...
      <Card className="p-5">
        ...
        <div className="space-y-3">
          {[
            {
              id: "stunting",
              label: "Alert Balita Pendek", // FASE 2: Penghalusan Terminologi
              desc: "Notifikasi saat ada balita dengan Z-Score < -2 SD",
              icon: AlertTriangle,
              color: "text-red-600 bg-red-50 dark:bg-red-500/10",
            },
            {
              id: "pengukuran",
              label: "Pengingat Input Pengukuran",
              desc: "Pengingat rutin mencatat penimbangan bulanan balita",
              icon: Scale,
