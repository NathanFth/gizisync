...
const shortcutGroups: ShortcutGroup[] = [
  {
    ...
    items: [
      {
        keys: ["Ctrl", "K"],
        description: "Buka command palette / pencarian global",
        icon: Search,
      },
      {
        keys: ["?"],
        description: "Buka bantuan keyboard shortcuts",
        icon: Keyboard,
      },
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-lg">
        ...
        <div className="mt-2 rounded-lg bg-emerald-50 dark:bg-emerald-500/10 p-3 text-xs text-emerald-800 dark:text-emerald-300">
          ...
          <kbd className="rounded border border-emerald-300 bg-white px-1 font-semibold dark:border-emerald-500/30 dark:bg-emerald-500/10">
            Ctrl+K
          </kbd>{" "}
          kapan saja untuk mencari balita, atau navigasi cepat ke modul mana
          pun.{" "}
        </div>
      </DialogContent>
    </Dialog>
