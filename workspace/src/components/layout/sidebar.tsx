...
export function Sidebar() {
  ...
  const totalIbuHamil = useStore((s) => s.ibuHamilList.length);
        ...
        <div className="border-t border-sidebar-border px-3 py-3">
          ...
          <div className="grid grid-cols-3 gap-1.5">
            ...
            <div className="rounded-lg bg-sidebar-accent/50 p-2 text-center">
              ...
              <p className="text-[9px] text-muted-foreground">Ibu Hamil</p>
            </div>
            <div className="rounded-lg bg-sidebar-accent/50 p-2 text-center">
              <p className="text-base font-bold text-sky-600 dark:text-sky-400">
                {totalPengukuran}
              </p>
              <p className="text-[9px] text-muted-foreground">Ukur</p>
            </div>
          </div>
        </div>
